...
export const LAYOUT = Object.freeze({
  ...
  //
  // 値の幅70pxは、TEXT_IMGが並べるPNGの実寸から決めている（数字17px・
  // 度と符号12px・h_space 1px）。最悪ケースは華氏3桁の "100°" で
  // 17*3 + 12 + 1*3 = 66px。氷点下 "-10°" は 61px。
  // 旧値の62pxは摂氏しか想定しておらず、華氏の3桁で4pxはみ出していた。
  range: {
    lowLabel: { x: 170, y: 368, w: 16, h: 20 },
    lowValue: { x: 186, y: 366, w: 70, h: 26 },
    highLabel: { x: 264, y: 368, w: 16, h: 20 },
    highValue: { x: 280, y: 366, w: 70, h: 26 },
  },
